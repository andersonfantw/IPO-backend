...
Route::get('/AccountReportSendingSummary','AccountReportSendingSummary@index')->name('AccountReportSendingSummary');
Route::get('/AccountReport','AccountReport@index')->name('AccountReport');
