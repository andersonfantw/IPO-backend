...
<body>
    <h1>有關客戶常設授權續期通知</h1>
    <p>客戶請注意，閣下所持有中國銀盛國際證券有限公司以下部分或全部帳戶（1.現金帳戶(包括全權授權委託帳戶〔如適用〕)/2.保證金帳戶）的常設授權有效期於2021年6月30日即將屆滿。本公司需要閣下的授權以便繼續為閣下提供所持有帳戶的服務，如本集團於2021年6月15日或之前仍未收到閣下的書面反對，閣下的常設授權書將自動續期十二個月。閣下將於續期後一星期內收到本公司的確認書。
    </p>
    ...
    <hr>
    <h1>Standing Authority Renewal Notice</h1>
    <p>The standing authority of your following applicable accounts at China Yinsheng International Securities Limited
        (1.cash account (Included Discretionary account management〔If applicable〕/ 2.margin account) is due to expire on
    ...
    <div>(This is a computer generated letter. No Signature is required)</div>
</body>
