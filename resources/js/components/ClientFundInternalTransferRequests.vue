  ...
  <b-container fluid class="p-0">
    <b-row no-gutters>
      ...
      <b-col>
        <SearchSelectOptions
          :name="'狀態'"
          :store-name-spaced="'ClientFundInternalTransferRequests'"
        >
...
export default {
  ...
  computed: {
    filters: {
      get() {
        return this.$store.state.ClientFundInternalTransferRequests.filters;
      },
      set(value) {
        this.$store.commit("ClientFundInternalTransferRequests/filters", value);
      },
    },
  },
  watch: {},
