<template>
    <div id="ae_commission_summary">
        ...
        <b-sidebar id="detail" title="AE確認表" shadodw>
            <b-button size="sm" variant="success" class="m-2 float-right" @click="window.open('AeCommissionSummary/detail/showPdf/'+target_item.uuid+'?start='+target_item.start_date+'&end='+target_item.end_date)"><i class="fas fa-file-download"></i> 下載AE確認表</b-button>
