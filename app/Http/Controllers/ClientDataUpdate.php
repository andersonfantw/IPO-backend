    ...
    public function index()
    {
        return ClientAddressProofUpdate::leftJoin('client_address_proof','client_address_proof_updates.uuid','=','client_address_proof.uuid')
            ...
            ->union(ClientBusinessTypeUpdate::leftJoin('client_business_type','client_business_type_updates.uuid','=','client_business_type.uuid')
                ...
                ->selectRaw("json_object('type',client_hk_idcard_updates.type,'idcard_face',client_hk_idcard_updates.idcard_face,'idcard_back',client_hk_idcard_updates.idcard_back,'name_c',client_hk_idcard_updates.name_c,'name_en',client_hk_idcard_updates.name_en,'gender',client_hk_idcard_updates.gender,'birthday',client_hk_idcard_updates.birthday,'idcard_no',client_hk_idcard_updates.idcard_no) as updating")
                ->selectRaw("json_object('type',client_hk_idcard.type,'idcard_face',client_hk_idcard.idcard_face,'idcard_back',client_hk_idcard.idcard_back,'name_c',client_hk_idcard.name_c,'name_en',client_hk_idcard.name_en,'gender',client_hk_idcard.gender,'birthday',client_hk_idcard.birthday,'idcard_no',client_hk_idcard.idcard_no) as original")
                ...
                ->selectRaw("json_object('type',client_other_idcard_updates.type,'idcard_face',client_other_idcard_updates.idcard_face,'idcard_back',client_other_idcard_updates.idcard_back,'name_c',client_other_idcard_updates.name_c,'name_en',client_other_idcard_updates.name_en,'gender',client_other_idcard_updates.gender,'birthday',client_other_idcard_updates.birthday,'idcard_no',client_other_idcard_updates.idcard_no) as updating")
                ->selectRaw("json_object('type',client_other_idcard.type,'idcard_face',client_other_idcard.idcard_face,'idcard_back',client_other_idcard.idcard_back,'name_c',client_other_idcard.name_c,'name_en',client_other_idcard.name_en,'gender',client_other_idcard.gender,'birthday',client_other_idcard.birthday,'idcard_no',client_other_idcard.idcard_no) as original")
            ...
            )->union(ClientInvestmentOrientationUpdate::leftJoin('client_investment_orientation','client_investment_orientation_updates.uuid','=','client_investment_orientation.uuid')
