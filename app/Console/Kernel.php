...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        // $schedule->command('tradego:import today')->dailyAt('10:10');
        $schedule->command('tradego:cashinimport today')->dailyAt('12:10');
        $schedule->command('tradego:cashinimport today')->dailyAt('14:10');
        $schedule->command('tradego:cashinimport today')->dailyAt('16:10');
