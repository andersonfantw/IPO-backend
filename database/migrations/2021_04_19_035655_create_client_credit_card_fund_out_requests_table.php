...
class CreateClientCreditCardFundOutRequestsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $table_name = 'client_credit_card_fund_out_requests';
    ...
    {
        // Schema::dropIfExists('client_credit_card_fund_out_requests');
    }
}
