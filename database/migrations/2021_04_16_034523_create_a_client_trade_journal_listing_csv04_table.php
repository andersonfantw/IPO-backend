...
class CreateAClientTradeJournalListingCsv04Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $table_name = 'a_client_trade_journal_listing_csv04';
        if(Schema::hasTable($table_name)){
            ...
            Schema::create($table_name, function (Blueprint $table) {
                ...
                $table->decimal('ex_rate', 22, 6)->nullable();
                ...
                $table->decimal('buy_charge', 22, 6)->nullable();
                $table->decimal('sell_charge', 22, 6)->nullable();
                ...
                $table->decimal('cash_charge', 22, 6)->nullable();
                $table->decimal('dvp_charge', 22, 6)->nullable();
                $table->decimal('margin_charge', 22, 6)->nullable();
                $table->decimal('staff_charge', 22, 6)->nullable();
                $table->decimal('house_charge', 22, 6)->nullable();
                $table->decimal('other_acctype_charge', 22, 6)->nullable();
                $table->decimal('other_acctype_charge_2', 22, 6)->nullable();
    ...
    {
        // Schema::dropIfExists('a_client_trade_journal_listing_csv04');
    }
}
