...
class CreateClientFundInternalTransferRequestsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $table_name = 'client_fund_internal_transfer_requests';
    ...
    {
        // Schema::dropIfExists('client_fund_internal_transfer_request');
    }
}
