...
class CreateClientBusinessTypeTable extends Migration
{
    ...
    public function up()
    {
        $table_name = 'client_business_type';
        if(Schema::hasTable($table_name)){
            ...
            Schema::create($table_name, function (Blueprint $table) {
                ...
                $table->tinyInteger('agree_direct_promotion')->nullable(false);
                $table->json('direct_promotion')->nullable(false);
                $table->timestamps();
            });
    ...
    {
        // Schema::dropIfExists('client_business_type');
    }
}
