...
class CreateClientOverseasFundOutRequestsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $table_name = 'client_overseas_fund_out_requests';
        if(Schema::hasTable($table_name)){
            ...
            Schema::create($table_name, function (Blueprint $table) {
                ...
                $table->string('swift_code',50)->nullable(false);
                $table->string('account_in',20)->nullable(false)->index();
                $table->string('bank_address')->nullable();
                $table->string('bank_address_text')->nullable();
    ...
    {
        // Schema::dropIfExists('client_overseas_fund_out_request');
    }
}
