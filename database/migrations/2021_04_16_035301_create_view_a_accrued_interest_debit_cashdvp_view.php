...
class CreateViewAAccruedInterestDebitCashdvpView extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::statement("DROP VIEW IF EXISTS view_a_accrued_interest_debit_cashdvp");
        $sql=<<<SQL
CREATE VIEW `view_a_accrued_interest_debit_cashdvp` AS
    SELECT 
    ...
    WHERE
        (a_client_fund_in_out_listing_csv01.gl_mapping_item_id = 'OTH:AccruedInterestDebit_CashDVP');
SQL;
        DB::statement($sql);
    }
