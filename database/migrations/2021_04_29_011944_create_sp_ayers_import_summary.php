...
class CreateSpAyersImportSummary extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::unprepared("DROP PROCEDURE IF EXISTS sp_ayers_import_summary");
        $sql=<<<SQL
        CREATE PROCEDURE `sp_ayers_import_summary`()
        BEGIN
