...
class CreateViewAIpoInterestView extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::statement("DROP VIEW IF EXISTS view_a_ipo_interest");
        $sql=<<<SQL
CREATE VIEW `view_a_ipo_interest` AS
    SELECT 
    ...
    WHERE
        (a_client_fund_in_out_listing_csv01.gl_mapping_item_id = 'OTH:IPOInterest');
SQL;
        DB::statement($sql);
    }
