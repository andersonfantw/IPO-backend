...
class CreateClientAddressProofTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $table_name = 'client_address_proof';
        if(Schema::hasTable($table_name)){
            ...
            Schema::create($table_name, function (Blueprint $table) {
                ...
                $table->json('detailed_address')->nullable();
    ...
    {
        // Schema::dropIfExists('client_address_proof');
    }
}
