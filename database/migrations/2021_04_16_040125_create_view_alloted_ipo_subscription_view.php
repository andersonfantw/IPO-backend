...
class CreateViewAllotedIpoSubscriptionView extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::statement("DROP VIEW IF EXISTS view_alloted_ipo_subscription");
        $sql=<<<SQL
CREATE VIEW `view_alloted_ipo_subscription` AS
    SELECT 
    ...
    WHERE
        (`b`.`gl_mapping_item_id` = 'OTH:IPOSubscription');
