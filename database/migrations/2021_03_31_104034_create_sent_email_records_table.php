...
class CreateSentEmailRecordsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        if(Schema::hasTable($table_name)){
            ...
            Schema::create($table_name, function (Blueprint $table) {
                ...
                $table->string('sent_by',100)->nullable(false);
                $table->timestamps();
            });
    ...
    {
        // Schema::dropIfExists('sent_email_records');
    }
}
