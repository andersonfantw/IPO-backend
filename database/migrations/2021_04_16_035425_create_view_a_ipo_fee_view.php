...
class CreateViewAIpoFeeView extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::statement("DROP VIEW IF EXISTS view_a_ipo_fee");
        $sql=<<<SQL
CREATE VIEW `view_a_ipo_fee` AS
    SELECT
    ...
    WHERE
        (a_client_fund_in_out_listing_csv01.gl_mapping_item_id = 'OTH:IPOFee');
SQL;
        DB::statement($sql);
    }
